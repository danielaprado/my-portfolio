...
export default function CopyButton() {
  ...
  return (
    ...
    >
      <div className="absolute flex justify-center gap-3 left-0 -top-8 w-[365px] py-4 bg-background text-3xl hover:border-solid border-dashed border-white border text-white z-20">
