...
export default function CopyButton() {
  ...
  return (
    ...
    >
      <div className="absolute flex justify-center items-center gap-3 left-0 -top-8 sm:w-[365px] w-[200px] py-4 bg-background sm:text-3xl text-lg hover:border-solid border-dashed border-white border text-white z-20">
